...
<div class="content-wrapper">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered dt-responsive nowrap" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" action="controllers/ListeActions.php">
                                    <input type="hidden" name="id" value="<?php echo $Numero_Dossier ?>">
                                    <button class="btn" style="color: #ffffff; margin-left:20px; background-color: #28a745"><i class="fa fa-plus" id="detaiactivite"> </i> </button>
                                </form>
                            </td>
                        </tr>
                        <?php }
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-header" style="background-color: #28a745;color:#ffffff;" id="TopListeActivite">
                <i class="fa fa-liste" style="color:#ffffff;font-size:30px;margin-right:20px;"></i>La liste des activités</div>
            <div class="card-body" id="ListeActiviteBody"  >
                <div class="table-responsive">
                    <table class="table table-striped table-bordered dt-responsive nowrap" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                        <tr>
...
actions.Numero_Dossier=$id");// lancement de la requette
                            echo $ligneretournee =$Sql_Activite->rowCount();
                            while($donnees_Activites = $Sql_Activite->fetch(PDO::FETCH_ASSOC)){
                            ?>
                            <td><?php echo $Nomdossier = $donnees_Activites['NomDossier'];?></td>
                            <td><?php echo $Activite = $donnees_Activites['Nom_Action'];  ?></td>
                            <td><?php echo $Acteur=$donnees_Activites['Acteurs']; ?></td>
                            <td><?php echo $DatePrevisionnelle=$donnees_Activites['Date_Previsionnelle']; ?></td>
                            <td><?php echo $Dateexecution=$donnees_Activites['Date_Execution']; ?></td>
                            <td><?php echo $Livrable=$donnees_Activites['Livrable']; ?></td>
                        </tr>
                        <?php }// fin tableau ?>
                        </tbody>
                    </table>
...
<script>
    $(function(){
        $('#ajouteractivite').click(function(){
            $('#TopListeActivite').hide();
            $('#ListeActiviteBody').hide();
...
<!--<script>
    $(function(){
        $('#detaiactivite').click(function(){
            $('#TopListeActivite').toggle();
            $('#ListeActiviteBody').toggle();
            $('#topajouterdossier').hide();
            $('#ajouderdossierbody').hide();
            $('#TopListeDossier').hide(); // je cache la barre haute de la table liste dossier
            $('#ListeDossierBody').hide(); // je cache la table liste dossiers
