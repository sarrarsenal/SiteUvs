...
<div class="content-wrapper">
                           ...
                           // $idactivite=0;
                            ...
                            <td>
                                <form action = "<?php $_PHP_SELF ?>" method = "GET">
                                   ...
                                   <button class="btn" style="color: #ffffff; margin-left:20px; background-color: #28a745" id="detaiactivite"><i class="fa fa-plus" > </i> </button>
                                </form>
                            </td>
                           </tr>
                        <?php }
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-header" style="background-color: #28a745;color:#ffffff;display:none" id="TopListeActivite">
